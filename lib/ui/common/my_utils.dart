...
//   static _showSnackbar(String title, String message, var color,
//       {IconData? icon}) {
//     NavigationService navigationService = locator<NavigationService>();

// //remove all from scaffoldmessenger
//     ScaffoldMessenger.of(navigationService.getNavigationContext())
//         .clearSnackBars();
...
//                     child: Text(
//                       title,
//                       style: myStyle(16, true, color: Colors.white),
//                     ),
//                   ),
//                 ],
//               ),
...
//               Text(
//                 message,
//                 style: myStyle(14, false, color: Colors.white),
//               ),
//             ],
//           )),
//     ));
//   }
  ...
  //   _showSnackbar(title, message, Colors.red.shade400,
  //       icon: Icons.error_outline);
  // }

  // static showSuccessSnackBar(String title, String message) {
  //   _showSnackbar(title, message, Colors.green.shade400,
